...
def main():
    ...
    #selected_feature_names = ['lFootPos', 'rFootPos', 'lFootVel', 'rFootVel','trajectoryPos2D','trajectoryRot2D']
    #selected_feature_weights = [0.75, 0.75, 0.75, 0.75,1, 1]

    #selected_feature_names = ['lFootPos', 'rFootPos','lHandPos','rHandPos','trajectoryPos2D']
    #selected_feature_weights = [1,1,1,1,1]

    #selected_feature_names = ['lFootPos', 'rFootPos', 'lFootVel', 'rFootVel', 'hipVel','trajectoryPos2D']
    #selected_feature_weights = [0.75, 0.75, 1, 1, 1, 1]
    
    selected_feature_names = ['lFootPos', 'rFootPos','lFootRot', 'rFootRot', 'lFootVel', 'rFootVel', 'trajectoryPos2D']
